        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span><a href="/tmtype/create"> 新增</a></button>
            </div>
          </div>
        </div>
               ...
               @foreach($type as $value)
                <tr>
                  ...
                  <td>
                    <div class="am-btn-toolbar">
                      <div class="am-btn-group am-btn-group-xs">
                        <a href="/tmtype/{{$value->id}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a><br>

                        <form action="/tmtype/{{$value->id}}" method="post">
                        {{method_field("DELETE")}}
                        {{csrf_field()}}
