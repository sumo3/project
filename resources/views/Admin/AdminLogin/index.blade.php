...
<div class="tyg-div">
	<ul>
    	<li>心</li>
    	<li><div style="margin-left:20px;">之</div></li>
    	<li><div style="margin-left:40px;">所</div></li>
    	<li><div style="margin-left:60px;">向</div></li>
    	<li><div style="margin-left:80px;">便</div></li>
    	<li><div style="margin-left:100px;">是</div></li>
    	<li><div style="margin-left:120px;">光</div></li>
    </ul>
</div> 
<div id="contPar" class="contPar">
	<div id="page1"  style="z-index:1;">
		<div class="title0">在线考试后台登陆</div>
		<div class="title1">让学习成为一种习惯</div>
		<div class="imgGroug">
			<ul>
				<img alt="" class="img0 png" src="/static/Admin/Login/img/page1_0.png">
				<img alt="" class="img1 png" src="/static/Admin/Login/img/page1_1.png">
				<img alt="" class="img2 png" src="/static/Admin/Login/img/page1_2.png">
			</ul>
		</div>
		<img alt="" class="img3 png" src="/static/Admin/Login/img/page1_3.jpg">
	</div>
</div>
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
		<form action="/login" method="post">
			<h2>登录</h2><p class="tyg-p">欢迎来到  德莱联盟</p>
